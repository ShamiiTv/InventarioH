...
class IngresoRopaController extends Controller
{
    public function showForm()
    {
        ...
        $ingresosRopa = IngresoRopa::with('user')->get(); // Cargar registros con usuarios
        return view('IngresoRSC', ['tiposPrendas' => $tiposPrendas, 'ingresosRopa' => $ingresosRopa]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('IngresoRSC')->with('success', 'Ingreso registrado exitosamente.');
    }
